...
class ACTLayer(nn.Module):
    ...
    """
    def __init__(self, action_dim, inputs_dim, use_orthogonal, gain, args=None):
    ...
    def forward(self, x, available_actions=None, deterministic=False):
        ...
        """
        action_logits = self.action_out(x, available_actions) if self.discrete_action else self.action_out(x)
    ...
    def evaluate_actions_trpo(self, x, action, available_actions=None, active_masks=None):
        ...
        action_log_probs = action_logits.log_probs(action)
        all_probs = action_logits.logits if self.discrete_action else None
