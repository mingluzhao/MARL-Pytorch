...
do
    ...
    --n_training_threads 1 --n_rollout_threads 1 --use_render True --save_gifs True --episode_length 75 --render_episodes 5 --use_wandb \
    --ppo_epoch 10 --use_ReLU --gain 0.01 --lr 7e-4 --critic_lr 7e-4 \
    --model_dir "results/MPE/simple_tag/rmappo/2pred_1prey/wandb/latest-run/files"
done
