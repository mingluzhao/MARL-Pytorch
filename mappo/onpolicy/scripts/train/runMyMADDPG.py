...
def main():
    ...
    rewardSheep = RewardSheepWithBiteAndKill(wolvesID, sheepsID, entitiesSizeList, getPosFromAgentState, isCollision,
                                            punishForOutOfBound, getCaughtHistoryFromAgentState, sheepLife, biteReward, killReward)
...
#------------ models ------------------------
    ...
    folderName = 'newRewardAllSheep0.2blockSize12Wepisode0.05dt10KillReward6SheepLife1.2killZoneRatio_ssr5_3'
