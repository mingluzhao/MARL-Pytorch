...
def visualize(numSheep, trainSheepSpeed, evalSheepSpeed, individualRewardWolf, continuous, killZoneRatio, seed = None):
    ...
    if seed:
        exp_name = f'../results/trajectories/apples/{cont}/{numWolves}pred_{numSheep}prey-{numBlocks}block-sheepspeed{trainSheepSpeed}-indivd{individualRewardWolf}-discrete{discrete_action}-killzone{killZoneRatio}-seed{seed}-evalspeed{evalSheepSpeed}.pkl'
    else:
        import glob
        pattern = f'../results/trajectories/apples/{cont}/{numWolves}pred_{numSheep}prey-{numBlocks}block-sheepspeed{trainSheepSpeed}-indivd{individualRewardWolf}-discrete{discrete_action}-killzone{killZoneRatio}-seed*-evalspeed{evalSheepSpeed}.pkl'
