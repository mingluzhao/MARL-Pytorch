...
def main():
    ...
    save_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[0] + "/results/trajectories/discrete")
    ...
    resultLoc = os.path.join(dirName, 'continuous_generate_traj_result.pkl')
