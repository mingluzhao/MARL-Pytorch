...
do
    ...
    --n_training_threads 1 --n_rollout_threads 128 --num_mini_batch 1 --episode_length 75 --num_env_steps 20000000 \
    --ppo_epoch 10 --use_ReLU --gain 0.01 --lr 7e-4 --critic_lr 7e-4 --wandb_name "xxx" --user_name "minglu-zhao" 
done